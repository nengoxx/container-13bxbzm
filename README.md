...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-13bxbzm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-13bxbzm.containers.anotherwebservice.com/
...
```
git clone git@github.com:nengoxx/container-13bxbzm.git
cd container-13bxbzm
```
...
```
docker attach container-13bxbzm
```
